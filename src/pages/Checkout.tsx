...
export default function Checkout() {
  ...
  //   const Data = await createOrder({ products: cartData.products })
  ...
  const handlePlaceOrder = async () => {
    try {
      ...
      console.log('User ID when placing order:', currentUser.userId)

      // Format the data according to backend expectations
      const orderData = {
        // Explicitly include userId in the request
      ...
      // More specific error handling based on the error
  ...
  //     await createOrder(orderDetail).unwrap();
  //   } catch (err) {
